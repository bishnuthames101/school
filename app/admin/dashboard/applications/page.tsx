...
import { FileText, Search, Calendar, User, Mail, Phone, MapPin, GraduationCap, ArrowLeft } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="relative z-[70]">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">View and manage student admission applications</p>
        </div>
      </div>
